...
public class TaskDoneAdapter extends BaseAdapter {
    ...
    public TaskDoneAdapter(Activity activity, List<Status> itemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_progress_done_layout, null);
        ...
        TextView txtTanggal = (TextView) convertView.findViewById(R.id.tgl_done);
        TextView txtBulan= (TextView) convertView.findViewById(R.id.bulan_done);
